      ...
      <div className=" mt-8">
        ...
        <div className="mt-6 ml-2 md:ml-4 space-y-4">
          <div className=" flex space-x-8 md:space-x-10 ">
            ...
            <div>
              <div className=" text-[#fafafa] md:text-xl font-semibold">Web Programmer</div>
              <div className=" text-[#ceb15a] text-sm md:text-lg">2016 — 2017</div>
              <div className=" text-[#d6d6d6] text-sm md:text-lg">at Nusantara Citra</div>
            </div>
          </div>
          <div className=" flex space-x-8 md:space-x-10 ">
            <div>
            ...
            <div>
              <div className=" text-[#fafafa] md:text-xl font-semibold">Backend Developer</div>
              <div className=" text-[#ceb15a] text-sm md:text-lg">2018 — 2020</div>
              <div className=" text-[#d6d6d6] text-sm md:text-lg">at Codelabs Indonesia</div>
            </div>
          </div>
          <div className=" flex space-x-8 md:space-x-10 ">
            <div>
            ...
            <div>
              <div className=" text-[#fafafa] md:text-xl font-semibold">Fronted Developer</div>
              <div className=" text-[#ceb15a] text-sm md:text-lg">2020 — Now</div>
              <div className=" text-[#d6d6d6] text-sm md:text-lg">at Codelabs Indonesia</div>
            </div>
          </div>
          <div className=" flex space-x-8 md:space-x-10 ">
            ...
            <div>
              ...
              <div className=" text-[#ceb15a] text-sm md:text-lg">2022 — Now</div>
              <div className=" text-[#d6d6d6] text-sm md:text-lg">at Codelabs Indonesia</div>
            </div>
          </div>
        </div>
